...
const apiEndpoint = 'http://192.99.147.139/' // change api.moustachedesign.xyz to your wordpress url
...
export default {
    ...
    url: 'https://hai-nyzhnyk.herokuapp.com/', //'https://nuxt-headless.netlify.com/', // your website url
